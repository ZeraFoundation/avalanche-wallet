        ...
        meta: [
            {
                ...
                name: 'description',
                content:
                    'Zera wallet is a simple, highly secure, non-custodial crypto wallet for storing AVAX.',
            },
            {
                vmid: 'og:description',
                name: 'description',
            ...
            },
            {
                vmid: 'og:title',
                name: 'og:title',
                content: 'Fastest Performing and Secure DeFi Wallet | Zera Wallet',
            },
        ],
        title: 'Fastest Performing and Secure DeFi Wallet',
        titleTemplate: '%s | Zera Wallet',
    },
}
</script>
